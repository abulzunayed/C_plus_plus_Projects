/* 
// =========== Simple Bank Managment System =============

Project : A simple Bank System that lets users create a abnk account with a basic registration system, deposit, withdraw money, Balance check.
